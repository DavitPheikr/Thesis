# G2 Visual Inspection Notes

Use this file to record manual observations from front-camera overlay PNGs.

Overlay location:
`logs/milestone_g/run_analysis/front_camera_predictions/G2_schedule_extend_100/`
...
- Does behaviour change after the LR drop compared with F0?
