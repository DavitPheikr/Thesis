...
4. `lr_schedule.png` - LR changes; best epoch is 27.
...
9. `confusion_best_checkpoint.png` - row-normalized confusion at epoch 27.
10. `confusion_final_epoch.png` - row-normalized confusion at epoch 35.
11. `runtime_and_memory.png` - compute cost and memory.

Sampled best-checkpoint plots live under `sampled_error_analysis_epoch27/plots/`.
